...
const Register = () => {
  ...
  return (
    <div className="register-container">
      <form onSubmit={order} className="register-form">
        <h1 className="register-head">Contact Us</h1>
        <input
          id="custname"
          key={`custName-${animationKey}`}
          type="text"
          name="custname"
          className={custNameValid ? "" : "register-error-input"}
          value={custName}
        ...
        <input
          ...
          type="email"
          name="email"
          className={emailValid ? "" : "register-error-input"}
          value={email}
        ...
        <input
          ...
          type="tel"
          name="mobile"
          className={mobileValid ? "" : "register-error-input"}
          value={mobile}
          onChange={(e) => setMobile(e.target.value)}
          autoComplete="tel"
          placeholder="Contact Number"
        />
        <textarea placeholder="Message" className="register-text"></textarea>
